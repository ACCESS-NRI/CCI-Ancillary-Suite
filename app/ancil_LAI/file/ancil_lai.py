...
def load_data(sources, relative_weights_path):
    ...
    lct = ants.io.load.load_cube(sources, lct_stash_con)
...
def main(sources, relative_weights_path, output_filepath, netcdf_only):
...
if __name__ == '__main__':
    ...
    main(args.sources, args.relative_weights, args.output, args.netcdf_only)
