...
def load(units_filepath, lct_fraction_filepath):
    ...
    """
    units_cube = ants.load_cube(units_filepath)

    stash_con = iris.AttributeConstraint(STASH="m01s00i216")
    lct_fractions = ants.load_cube(lct_fraction_filepath, stash_con)
...
def main(soil_units_filepath, lct_fraction_filepath, lookup_filepath, ice_tile_id, output, use_new_saver):
    """
...
if __name__ == "__main__":
    ...
    main(args.sources, args.lct_ancillary, args.soils_lookup, args.ice_tile_id, args.output, args.use_new_saver)
